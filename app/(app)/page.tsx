  ...
  return (
    <div>
      ...
      <div className={"px-5 xl:px-20 py-5 grid grid-cols-1 md:grid-cols-3 gap-5"}>
        ...
        <div
          className="p-7 flex flex-col items-center border border-gray-200 rounded-md shadow xl:flex-row xl:space-x-10 xl:max-w-xl bg-gray-100 md:bg-white transition ease-in-out hover:bg-gray-100">
          <Image
