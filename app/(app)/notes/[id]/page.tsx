...
const NotePage = async ({params}: any) => {
  ...
  return (
    <div className={"px-10 md:px-20 mt-10 space-y-12"}>
      <h1 className={"font-bold text-center md:text-left text-3xl md:text-4xl w-full md:w-fit"}>{title}</h1>
      <div
        className={"cursor-text w-full xl:w-3/4 2xl:w-1/2 mt-10 mx-auto bg-yellow-300 space-y-8 p-5 shadow-2xl border-black border-2"}>
